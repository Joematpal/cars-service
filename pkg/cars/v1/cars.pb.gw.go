...
/*
Package v1_cars is a reverse proxy.
...
func request_CarsService_CreateCar_0(ctx context.Context, marshaler runtime.Marshaler, client CarsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Car
...
func local_request_CarsService_CreateCar_0(ctx context.Context, marshaler runtime.Marshaler, server CarsServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Car
	var metadata runtime.ServerMetadata
...
func RegisterCarsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CarsServiceServer) error {
	...
	mux.Handle("POST", pattern_CarsService_CreateCar_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/cars.CarsService/CreateCar", runtime.WithHTTPPathPattern("/api/v1/cars/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_CarsService_CreateCar_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CarsService_CreateCar_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// "CarsServiceClient" to call the correct interceptors.
func RegisterCarsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CarsServiceClient) error {
	...
	mux.Handle("POST", pattern_CarsService_CreateCar_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/cars.CarsService/CreateCar", runtime.WithHTTPPathPattern("/api/v1/cars/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_CarsService_CreateCar_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CarsService_CreateCar_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "cars", "id"}, ""))
)

var (
	forward_CarsService_CreateCar_0 = runtime.ForwardResponseMessage
)
